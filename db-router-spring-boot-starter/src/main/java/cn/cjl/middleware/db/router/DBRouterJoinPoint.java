...
public class DBRouterJoinPoint {
    ...
    @Pointcut("@annotation(cn.cjl.middleware.db.router.annotation.DBRouter)")
     ...
     * 5. 最后 dbRouterStrategy 需要执行 clear 因为这里用到了 ThreadLocal 需要手动清空。防止 ThreadLocal 内存泄漏介
     */
